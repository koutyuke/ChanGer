/*
  ...
  - You are about to drop the column `channel_id` on the `Team` table. All the data in the column will be lost.
  - Added the required column `connect_channel_id` to the `Team` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Member" (
    ...
    CONSTRAINT "Member_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "Team" ("connect_channel_id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Team" (
    "team_name" TEXT,
    "guild_id" TEXT NOT NULL,
    "connect_channel_id" TEXT NOT NULL PRIMARY KEY,
...
INSERT INTO "new_Team" ("guild_id", "team_name") SELECT "guild_id", "team_name" FROM "Team";
DROP TABLE "Team";
